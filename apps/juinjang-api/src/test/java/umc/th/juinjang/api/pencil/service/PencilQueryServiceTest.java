...
//
// 		// 명확한 순서로 데이터 생성 (시간 역순으로)
// 		PurchasedPencil pencil1 = PurchasedPencil.successOf(member, "10개 연필팩", 10L, 1000L, 10L, 0, "transaction1",
// 			uuid1, time1);
// 		PurchasedPencil pencil2 = PurchasedPencil.successOf(member, "20개 연필팩", 20L, 2000L, 30L, 0, "transaction2",
// 			uuid2,
// 			time2);
// 		PurchasedPencil pencil3 = PurchasedPencil.successOf(member, "30개 연필팩", 30L, 3000L, 60L, 0, "transaction3",
// 			uuid3,
// 			time3);
// 		PurchasedPencil pencil4 = PurchasedPencil.successOf(member, "15개 연필팩", 15L, 1500L, 75L, 0, "transaction4",
// 			uuid4,
// 			time4);
// 		PurchasedPencil pencil5 = PurchasedPencil.successOf(member, "25개 연필팩", 25L, 2500L, 90L, 0, "transaction5",
// 			uuid5,
// 			time5);
//
...
//
// 		PurchasedPencil pencil = PurchasedPencil.failedDueToServerError(member, "10개 연필팩", 10L, 1000L, 10,
...
// 			AcquiredPencil.create(member, "노트 작성", 1L, 10L, 10L, false, AcquiredType.NOTE)
// 		);
//
// 		// when
...
// 		assertThat(request.getLifetimeDollarsPurchased()).isEqualTo(
// 			LifetimeDollarsPurchased.ONE_CENT_TO_FORTY_NINE_DOLLARS_AND_NINETY_NINE_CENTS);
...
// 		return AcquiredPencil.createWithDate(member, content, sharedNoteId, acquiredQuantity, acquiredQuantity, isRead,
// 			type, createdAt);
// 	}
//
// }
