...
import umc.th.juinjang.api.apple.service.AppleServiceImpl;
...
public class PencilCommandServiceTest extends IntegrationTestSupport {
    ...
    @MockBean
    private AppleServiceImpl appleServiceImpl;
    ...
    void processAppleIAPPurchase_Success() throws APIException, VerificationException, IOException {
        ...
        when(appleServiceImpl.verifyAppleTransaction(any(AppleTransactionVerifyCommand.class)))
